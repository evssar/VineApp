...
function eventHandler() {
    ...
    document.getElementsByClassName("row-wrapper")[0].innerHTML = buffer;
    ...
    */
    ...
    button.addEventListener("click", function() {
        document.getElementsByClassName("intro-wrapper")[0].style.display = 'none';
    ...
    */
    var elements = document.getElementsByClassName("item-button");
